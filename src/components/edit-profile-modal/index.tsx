...
export const EditProfileModal: React.FC<Props> = ({ onClose }) => {
    ...
    return (
        <div className="fixed inset-0 center z-50">
            ...
            <div className="relative bg-secondary dark:bg-dark__secondary w-[30rem] rounded-md overflow-hidden">
                <div className="flex justify-between px-8 py-4 bg-secondary-content dark:bg-dark__secondary-content ">
                    <div>
                        <h3>Profile Edit</h3>
                    </div>
                ...
                <form onSubmit={handleSubmit(onSubmit)} className="px-8 pt-2 pb-4 mt-4">
                    <div className="space-y-2">
                        ...
                        <div className="relative flex rounded overflow-hidden mb-4 items-center h-10 focus-within:ring-2 ring-primary/50 ">
                    ...
                    <div className="mt-6 space-y-2">
                        ...
                        <div className="flex rounded  overflow-hidden mb-4 items-center h-10 focus-within:ring-2 ring-primary/50">
                            <div className="bg-secondary-content dark:bg-dark__secondary-content h-full w-10 center">
