...
export const EditAvatar: React.FC<Props> = () => {
    ...
    const handleSaveImage = async () => {
        try {
            await updateProfileMutation.mutateAsync({ avatar: image });
        } catch (error) {
            console.log(error);
        }
    };
        ...
        <div>
            <div className="center py-4">
                <div
                    ...
                    role="button"
                    className="h-[200px] w-[200px] relative group"
                >
                    <img
                        className="object-cover rounded-full h-full shadow-lg"
                        src={`${
                            image ||
                    ...
                    <div className="absolute w-8 h-8 bg-dark__secondary-content center rounded-full bottom-4 right-4 opacity-70 group-hover:opacity-100 scale-90 group-hover:scale-110 duration-200 ">
            ...
            <div className="text-center mt-10">
                <button
                    ...
                    className="bg-primary w-[50%] py-1 rounded-md text-white shadow-md hover:bg-opacity-80"
                >
                    Save
                </button>
            </div>
